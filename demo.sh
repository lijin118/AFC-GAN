...
#zsl_flo: 70.51(ratio=0.7)
CUDA_VISIBLE_DEVICES=0 python3 ./afcgan.py --ensemble_ratio 0.8 --loss_syn_num 20 --cyc_seen_weight 1e-2 --cyc_unseen_weight 1 --dm_seen_weight 1e-4 --dm_unseen_weight 0.001 --dm_weight 1e-4  --cls_syn_num 1150 --cls_batch_size 150  --new_lr 1  --nepoch 110 --manualSeed 806 --cls_weight 0.1 --preprocessing --cuda --image_embedding res101 --class_embedding att --netG_name MLP_G --netD_name MLP_CRITIC --ngh 4096 --ndh 4096 --lambda1 10 --critic_iter 5 --dataset FLO --batch_size 64 --nz 1024 --attSize 1024 --resSize 2048 --lr 0.0001 --outname flowers

#zsl_sun: 63.33(ratio=0.8)
...
# gzsl_flo: 68.69(ratio=0.8)
CUDA_VISIBLE_DEVICES=0 python3 ./afcgan.py --ensemble_ratio 0.6 --loss_syn_num 15 --cyc_seen_weight 1 --cyc_unseen_weight 1 --dm_seen_weight 0.001 --dm_unseen_weight 0.001 --dm_weight 1e-4  --cls_syn_num 900  --cls_batch_size 300  --new_lr 0  --nepoch 90  --gzsl --nclass_all 102 --manualSeed 806 --cls_weight 0.1 --preprocessing --cuda --image_embedding res101 --class_embedding att --netG_name MLP_G --netD_name MLP_CRITIC --ngh 4096 --ndh 4096 --lambda1 10 --critic_iter 5 --dataset FLO --batch_size 64 --nz 1024 --attSize 1024 --resSize 2048 --lr 0.0001 --classifier_lr 0.001 --outname flowers

# gzsl_sun: 41.60(ratio=1.8)
